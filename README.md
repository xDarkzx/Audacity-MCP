...
>
> Script says it worked but transcription is still slow/on CPU? That means Claude Desktop is launching `audacity-mcp` from a different Python than the one the script just verified — see [the fix](docs/INSTALLATION.md#transcription-setup-optional) (a manual config edit, five minutes).
